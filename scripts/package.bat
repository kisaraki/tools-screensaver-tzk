...
set "DIST=%ROOT%\dist"
set "SCR=%DIST%\MyDateTimeScreensaver.scr"
set "SETUP=%DIST%\MyDateTimeScreensaver-Setup.exe"
set "SETUP_TEMP=%DIST%\MyDateTimeScreensaver-Setup.exe.%RANDOM%.%RANDOM%.tmp"
set "STAGE=%ROOT%\target\package-stage-%RANDOM%-%RANDOM%"
set "STAGED_SETUP=%STAGE%\MyDateTimeScreensaver-Setup.exe"
