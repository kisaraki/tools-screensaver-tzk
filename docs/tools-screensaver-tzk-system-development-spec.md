...
實作基準：產品 v0.15.1、設定 schema 10、Git tag `v0.15.1`
...
本文件記錄 `v0.15.1` 的實作。重建時先以 tag 固定參考原始碼，再依本文件驗證相容性：

| 項目 | v0.15.1 快照 |
| --- | --- |
| Git tag | `v0.15.1` |
| Git commit | 以 `git rev-parse 'v0.15.1^{commit}'` 取得，避免文件提交的自我參照 |
| Cargo／SCR／Setup 版本 | `0.15.1` |
| Registry schema | `10` |
...
| SCR | 20,509,696 bytes，SHA-256 `75832c33193e296898d5f084b203ac118d76bc4b827b0ce80fb3cf247e6764eb` |
| Setup | 23,310,157 bytes，SHA-256 `ef503b79630d8327fc3394de6f01b8a7b851e7384007e9d792cb1c6e54965f4a` |
...
未來重新開發只有在以下條件全部成立時，才可宣告與 v0.15.1 功能相容：
