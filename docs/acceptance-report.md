...
| AC29 | NOT TESTED | 御運轉士中央 16:9 player 與兩側設備、地方散策全畫面徑向暗角及無血管素材皆通過 WIC／GDI／HTML fixture；三種眨眼、380 ms 換片點與柔化眼瞼漸層由測試固定 | UT34、UT39、UT41、UT43～UT44、Phase 18 report | 實際影片中的暗角／眨眼、多螢幕與 GPU 表現未觀察 |
