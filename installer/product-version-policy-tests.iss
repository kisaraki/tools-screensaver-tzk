...
begin
  ...
  if Report = '' then
    Exit;
  try
    Check(ProductVersionsEqual('0.13.0.0', '0.13.0.0'), 'exact version');
    Check(ProductVersionsEqual('0.13.0', '0.13.0.0'), 'equivalent version');
    Check(ProductVersionsEqual(' 0.13.0.0 ', '0.13.0'), 'trim version');
    Check(not ProductVersionsEqual('0.12.1.0', '0.13.0.0'), 'older version');
    Check(not ProductVersionsEqual('0.14.0.0', '0.13.0.0'), 'newer version');
    Check(ProductVersionsEqual('unknown', ' unknown '), 'same malformed label');
    Check(not ProductVersionsEqual('unknown', '0.13.0.0'), 'malformed mismatch');
